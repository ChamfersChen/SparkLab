...
- 管理员发布**提示词模板**（五段式 Role/Goal/Input/Output/Example）和**Playbook 剧本**（多步骤顺序排列）
- 付费用户持**激活码邀请链接**完成注册
...
- ✅ **欢迎页 UI 上线**：`/` 为 public，Hero CTA 按登录态切换，3 张业务模块入口卡（骨架阶段 disabled）
- 🛠 **阶段 6 待开发**：业务模块（模板/Playbook/收藏/看板）
